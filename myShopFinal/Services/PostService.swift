...
class PostService {
    ...
    static func uploadPost(caption: String, category: String, imageData: Data, onSuccess: @escaping()-> Void, onError: @escaping (_
        ...
        StorageService.savePostPhoto(userId: userId, caption: caption, postId: postId, imageData: imageData, category: category, metadata: metadata,storagePostRef: storagePostRef, onSuccess: onSuccess, onError: onError)
